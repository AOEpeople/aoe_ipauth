 ...
 */
class Tx_AoeIpauth_Tests_Unit_Domain_Service_FeGroupsServiceTest extends Tx_AoeIpauth_Tests_Unit_BaseDatabaseTest {
	...
	public function setUp() {
		$this->fixture = $this->objectManager->get('Tx_AoeIpauth_Domain_Service_FeGroupsService');
		parent::setUp();
	}
